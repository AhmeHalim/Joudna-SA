...
class CategoryDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->rawColumns(['checkbox', 'actions', 'name_en', 'name_ar', 'image', 'status', 'home'])
            ->setRowId('id');
    }
    ...
    {
        return $row->home
            ? '<div class="badge badge-light-success">' . __('dash.published') . '</div>'
            : '<div class="badge badge-light-danger">'  . __('dash.inactive')  . '</div>';
    }
