<x-dashboard.layout :title="__('dash.roles')">
    ...
    <div class="card">
        ...
        <x-dashboard.partials.card_header :title="'roles'" :routeName="'users.roles'" :modelName="'roles'"
                                          :hasStatus="'no'" :hasCreate="'no'"/>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-body pt-1">
                                <!--begin::Users-->
                                <div class="fw-bold text-gray-600 mb-5">@lang('dash.Total users with this role')
                                ...
                                <div class="d-flex flex-column text-gray-600">
                                    ...
                                    @if($role->permissions->count() > 10)
                                        ...
                                        <div class='d-flex align-items-center py-2'><span
                                            ...
                                            <em>@lang('dash.and more permissions')...</em></div>
                                    @endif
                            ...
                            <div class="card-footer flex-wrap pt-0">
                                <a href="{{route('users.roles.edit',$role->id)}}"
                                   class="btn btn-light btn-active-primary">@lang('dash.edit_role')</a>
                                @if($key != 0 && $role->name!='crm_employee')
                                    <a href="javascript:;" class="btn btn-light btn-active-danger btn_delete_role_card"
                                       data-id="{{$role->id}}"
                                       data-delete_route="{{ route('users.roles.destroy',$role->id) }}">@lang('dash.delete_role')</a>
                                @endif
                            </div>
                            <!--end::Card footer-->
                        </div>
                        ...
                        <div class="card-body d-flex flex-center">
                            ...
                            <a href="{{route('users.roles.create')}}"
                               class="btn btn-clear d-flex flex-column flex-center">
                                <!--begin::Illustration-->
                                <img src="{{\app\Helper\Path::dashboardPath('media/illustrations/sketchy-1/4.png')}}"
