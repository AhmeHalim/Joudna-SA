...
namespace app\DataTables\WebsiteStatistics;
...
class WebsiteStatisticsDataTable extends DataTable
{
    ...
    {
        $editUrl = route('website-statistics.edit', $row->id);
        $routeName = 'website-statistics';
    ...
    public function query(WebsiteStatistics $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder{
        return $this->builder()
            ->setTableId('website-statistics-table')
    ...
    {
        return 'website_statistics_' . date('YmdHis');
    }
