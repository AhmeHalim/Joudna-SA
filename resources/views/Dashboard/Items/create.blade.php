<x-dashboard.layout :title="__('dash.add_item')">

    <form method="post" action="{{ route('items.store') }}" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{ route('items.index') }}" enctype="multipart/form-data">
        @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex mt-3">
                                                <div class="form-check form-check-custom form-check-solid me-5">
                                                    <input class="form-check-input" type="radio" value="1" name="recommended" @checked(old('home') == 1)>
                                                    <label class="form-check-label">@lang('dash.yes')</label>
                                                </div>
                                                <div class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" value="0" name="recommended" @checked(old('home') == 0)>
