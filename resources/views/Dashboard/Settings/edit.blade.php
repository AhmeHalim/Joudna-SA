                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    @foreach (config('languages') as $lang => $languageName)
                                        <x-dashboard.partials.html.textarea_with_editor :name="'site_desc_' . $lang"
                                                                                        :label="__('dash.site_desc') . '(' . $languageName . ')'"
                                                                                        :value="old(
                                                'site_desc' . $lang,
                                                $settings->getTranslation('site_desc', $lang) ?? '',
                                            )"
                                                                                        :placeholder="edit.blade.php__('dash.Enter the short dec in') . $languageName"/>
                                    @endforeach
                                </div>
                            </div>
                            <!--end::Card header-->
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        ...
                        <div class="d-flex flex-wrap gap-7">
                            ...
                            <x-dashboard.partials.html.image_input :title="'Upload Main Logo'" :name="'logo'"
                                                                   ...
                                                                   :changeImageText="'Change Logo'"
                                                                   :cancelImageText="'Cancel Logo'"
                                                                   :removeImageText="'Remove Logo'"
                                                                   :acceptedText="'image files are accepted'"
                                                                   :model="$settings" :imageModelName="'settings'"/>
                            <!--end::image -->
                            ...
                            <x-dashboard.partials.html.image_input :title="'Upload Fav Icon'" :name="'fav_icon'"
                                                                   :description="'Only *.png, *.jpg, and *.jpeg image files are accepted.'"
                                                                   :changeImageText="'Change Fav Icon'"
                                                                   :cancelImageText="'Cancel Fav Icon'"
                                                                   :removeImageText="'Remove Fav Icon'"
                                                                   :acceptedText="'image files are accepted'"
                                                                   :model="$settings" :imageModelName="'settings'"/>
                            <!--end::image -->
                        </div>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    ...
                                    <x-dashboard.partials.html.input name="sms_app_sec" label="App Secret"
                                                                     :value="old('sms_app_sec', $settings->sms_app_sec)"
